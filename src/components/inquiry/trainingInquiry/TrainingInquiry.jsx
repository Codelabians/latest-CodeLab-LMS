        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-gradient-to-r from-[#014376] to-[#31918D] rounded-xl shadow-lg">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#014376] to-[#31918D] text-white rounded-xl hover:shadow-xl transition-all duration-300 hover:scale-105 font-semibold"
            >
              <Download size={20} />
          ...
          <div className="flex">
            ...
            <button
              ...
              className={`flex-1 px-8 py-6 text-center font-semibold transition-all relative ${
                activeTab === "Technical"
                  ? "text-white bg-gradient-to-r from-[#014376] to-[#31918D]"
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="p-4 bg-gradient-to-r from-[#014376] to-[#31918D] rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                        <IconComponent className="w-7 h-7 text-white" />
                      </div>
                      <div className="flex flex-col items-end">
                        <span className="px-4 py-2 bg-gradient-to-r from-[#014376] to-[#31918D] text-white text-lg font-bold rounded-full shadow-md">
                          {courseStats.total}
                        </span>
                    ...
                    {/* Course Name */}
                    <h3 className="text-lg font-bold text-gray-900 mb-4 group-hover:text-[#014376] transition-colors">
                      {courseName}
                    </h3>
