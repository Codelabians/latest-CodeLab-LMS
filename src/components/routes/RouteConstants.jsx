...
export const PORTAL_SHARE_EARN = "/portal/share-earn";
...
export const SHARE_EARN_ADMIN = "/dashboard/share-earn";
...
export const SCHOLARSHIP_PROGRAMS = "/dashboard/finance/scholarship-programs";
export const FEE_STATUS = "/dashboard/finance/fee-status";
export const STUDENTS_ON_BREAK = "/dashboard/students/on-break";
...
export const EMPLOYEE_COMPLAINTS = "/dashboard/employees/complaints";
