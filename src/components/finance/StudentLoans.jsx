...
import {
  HandCoins, Plus, X, Loader2, Check, Ban, Send, CircleDollarSign, Search,
} from "lucide-react";
import {
                ...
                <tr key={l.loan_uuid} style={{ borderTop: `1px solid ${BORDER}` }}>
                  ...
                  <td className="px-3 py-2.5">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      {l.status === "approved" && (
                        <button disabled={posting} onClick={() => act(l.loan_uuid, "disburse", { disbursed_on: today() })} className="inline-flex items-center gap-1 px-2 py-1 rounded-md text-[11px] font-semibold" style={{ background: "#FEF2F2", color: BRAND }}><Send size={12} /> Disburse</button>
                      )}
