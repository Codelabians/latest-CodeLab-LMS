  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto m-4">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-[#aa0e0e] to-[#aa0e0e] text-white p-6 rounded-t-2xl flex items-center justify-between">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 rounded-xl p-5 border-l-4 border-[#aa0e0e]">
            <h3 className="text-lg font-bold text-[#aa0e0e] mb-3">Student Information</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#aa0e0e]"
                min="0"
                disabled={isGenerating}
              />
            </div>
          ...
          {/* Fee Summary */}
          <div className="bg-gradient-to-r from-blue-50 to-teal-50 p-5 rounded-xl border-2 border-[#d61111]">
            <div className="flex items-center gap-2 mb-4">
              <DollarSign className="w-5 h-5 text-[#d61111]" />
              <h3 className="font-bold text-[#aa0e0e]">Fee Summary</h3>
            </div>
          ...
          <div className="flex gap-4 justify-end">
            ...
            <button
              ...
              disabled={isGenerating}
              className="px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-[#aa0e0e] to-[#d61111] hover:from-[#aa0e0e] hover:to-[#aa0e0e] transition-colors flex items-center gap-2 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
